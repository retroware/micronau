...
#ifndef MICRONKNOB_H_INCLUDED
#define MICRONKNOB_H_INCLUDED
...
/*
	MicronSlider:
		This is just like the standard JUCE Slider except it supports fine control
		with right-click for LinearVertical and RotaryHorizontalVerticalDrag styles.
		
		NOTE: The code here was copied from JUCE library Slider and then modified,
		as well as subclassing from Slider, because it just seemed easier that way.
*/
//==============================================================================

class JUCE_API  MicronSlider  : public Slider
{
public:
    //==============================================================================
    ...
    */
    ...
    /** Creates a slider.
        When created, you can set up the slider's style and range with setSliderStyle(), setRange(), etc.
    */
    explicit MicronSlider (const String& componentName);

    /** Creates a slider with some explicit options. */
    MicronSlider (Slider::SliderStyle style, Slider::TextEntryBoxPosition textBoxPosition);
   ...
   void setSliderStyle (Slider::SliderStyle newStyle);
    ...
    /** Returns the slider's current style.
        @see setSliderStyle
    */
    Slider::SliderStyle getSliderStyle() const noexcept;
    ...
    */
    void setIncDecButtonsMode (Slider::IncDecButtonMode mode);
    ...
    */
    ...
    /** Returns the status of the text-box.
        @see setTextBoxStyle
    */
    Slider::TextEntryBoxPosition getTextBoxPosition() const noexcept;
    ...
    */
    ...
    /** Changes the slider's current value.
        ...
        This will trigger a callback to MicronSlider::Listener::knobValueChanged() for any listeners
        ...
        @param notification     can be one of the NotificationType values, to request
                                ...
                                of any MicronSlider::Listeners that are registered.
    */
    ...
    */
    ...
    /** A class for receiving callbacks from a Slider.
        ...
        To be told when a slider's value changes, you can register a MicronSlider::Listener
        object using MicronSlider::addListener().

        @see MicronSlider::addListener, MicronSlider::removeListener
    */
    ...
    public:
        ...
        /** Called when the slider's value is changed.
            ...
            or by a call to MicronSlider::setValue().

            You can find out the new value using MicronSlider::getValue().

            @see MicronSlider::valueChanged
        */
        virtual void knobValueChanged (MicronSlider* slider) = 0;

        //==============================================================================
        /** Called when the slider is about to be dragged.

            This is called when a drag begins, then it's followed by multiple calls
            to knobValueChanged(), and then knobDragEnded() is called after the
            user lets go.

            @see knobDragEnded, MicronSlider::startedDragging
        */
        virtual void knobDragStarted (MicronSlider*) {}

        /** Called after a drag operation has finished.
            @see knobDragStarted, MicronSlider::stoppedDragging
        */
        virtual void knobDragEnded (MicronSlider*) {}
    };
#endif
    ...
    */
    ...
    /** Callback to indicate that the user is about to start dragging the slider.
        ...
        @see MicronSlider::Listener::knobDragStarted
    */
    virtual void startedDragging();

    /** Callback to indicate that the user has just stopped dragging the slider.

        @see MicronSlider::Listener::knobDragEnded
    */
    virtual void stoppedDragging();

    /** Callback to indicate that the user has just moved the slider.

        @see MicronSlider::Listener::knobValueChanged
    */
...
private:
	...
	// allow SliderBank to pass mouse events directly to us.
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR (MicronSlider)
};

/** This typedef is just for compatibility with old code - newer code should use the MicronSlider::Listener class directly. */
typedef MicronSlider::Listener MicronSliderListener;

#endif  // MICRONKNOB_H_INCLUDED
